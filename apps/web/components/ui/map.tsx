...
/* Vendored from mapcn (https://www.mapcn.dev) via `shadcn add @mapcn/map`.
 * Local change: two `features[0]` reads guarded for noUncheckedIndexedAccess.
 * Re-apply that guard if this file is regenerated. */
...
// Local change: upstream points this at unpkg.com, which our CSP blocks and
// which would make every map view depend on a third-party CDN at runtime. The
// worker is copied into public/ by scripts/copy-maplibre-worker.mjs.
